...
function create_post_type_rutas()
{
    ...
    register_post_type('rutas', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Rutas', 'html5blank'), // Rename these to suit
            'singular_name' => __('Rutas', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Rutas', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Rutas', 'html5blank'),
            'new_item' => __('New Rutas', 'html5blank'),
            'view' => __('View Rutas', 'html5blank'),
            'view_item' => __('View Rutas', 'html5blank'),
            'search_items' => __('Search Rutas', 'html5blank'),
            'not_found' => __('No se encontraron Rutas', 'html5blank'),
            'not_found_in_trash' => __('No Rutass found in Trash', 'html5blank')
        ),
        'public' => true,
        'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
        'has_archive' => true,
